...
load('case118mod_init_infeasiblepoint.mat', 'x0')
...
fprintf('---------------- IPOPT-mumps for 118-bus OPF result ----------------\n');
mpopt = mpoption('exp.use_legacy_core', 1, ...
    'opf.ac.solver', 'IPOPT', ...
    'opf.start', 5, ... %input initial point
...
fprintf('---------------- IPOPT-ma97 for 118-bus OPF result ----------------\n');
mpopt = mpoption('exp.use_legacy_core', 1, ...
    'opf.ac.solver', 'IPOPT', ...
    'opf.start', 5, ... %input initial point
    'ipopt.opts.print_level', 0, ...
...
%% knitro: SQP Method
fprintf('---------------- KNITRO- SQP Method for 118-bus OPF result ----------------\n');
mpopt = mpoption('exp.use_legacy_core', 1,...
    'opf.start', 5,...
    'opf.ac.solver', 'KNITRO',...
    'verbose',3);

function mpc = case9mod_self_Rec_nag12
%% Modified 9 bus case in MATPOWER format
%  W. A. Bukhsh, Feb 2013 
%%   References:
...
%% Modifications
%Reactive power bounds were tightened
mpc.gen(:,5) = -5;
%demands reduced to 60%
mpc.bus(:,3) = 0.60*mpc.bus(:,3);
mpc.bus(:,4) = 0.60*mpc.bus(:,4);



%% zcq modification：
%zcq:Reactive power bounds -12
mpc.gen(:,5) = -12;
%zcq: V bound [0.98, 1.02]
mpc.bus(:,end-1)= 1.02;
mpc.bus(:,end)= 0.98;

...
% This script implements the pglib_opf_case240_pserc system 
...
load('case240_Init_feasiblepoint.mat', 'x0');
...
fprintf('---------------- IPOPT-mumps for 240-bus OPF result ----------------\n');
mpopt = mpoption('exp.use_legacy_core', 1, ...
    'opf.ac.solver', 'IPOPT', ...
    'opf.start', 5, ... %input initial point
...
fprintf('---------------- IPOPT-ma97 for 240-bus OPF result ----------------\n');
mpopt = mpoption('exp.use_legacy_core', 1, ...
    'opf.ac.solver', 'IPOPT', ...
    'opf.start', 5, ... %input initial point
    'ipopt.opts.print_level', 0, ...
...
fprintf('---------------- KNITRO- Interior Point Method for 240-bus OPF result ----------------\n');
mpopt = mpoption('exp.use_legacy_core', 1,...
    'opf.start', 5,...
...
%% knitro: SQP Method
fprintf('---------------- KNITRO- SQP Method for 240-bus OPF result ----------------\n');
mpopt = mpoption('exp.use_legacy_core', 1,...
    'opf.start', 5,...
    'opf.ac.solver', 'KNITRO',...
    'verbose',3);

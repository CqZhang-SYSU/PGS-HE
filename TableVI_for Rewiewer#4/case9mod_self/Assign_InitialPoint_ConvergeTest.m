...
% under the same feasible point (...\case9mod_self\data\case9mod_self_init_feasilepoint.mat).


mpc = loadcase('case9mod_self');
load('case9mod_self_init_feasilepoint.mat', 'x0');
...
fprintf('---------------- IPOPT-mumps for 9-bus OPF result ----------------\n');
mpopt = mpoption('exp.use_legacy_core', 1, ...
    'opf.ac.solver', 'IPOPT', ...
    'opf.start', 5, ... %input initial point

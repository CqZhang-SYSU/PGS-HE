...
- **pglib_opf_case200_activ__api** – from PGLib OPF v23.07 [PGLIB-OPF](https://github.com/power-grid-lib/pglib-opf)
- **pglib_opf_case240_pserc** – from PGLib OPF v23.07 [PGLIB-OPF](https://github.com/power-grid-lib/pglib-opf)

The above PGLib cases correspond to standard congested and typical operating conditions.

- **case2383wp** – from MATPOWER 8.1 [MATPOWER 8.1](https://matpower.org)
